...
// CORS
@CrossOrigin(origins = "http://127.0.0.1:8080/api/v1", methods = {RequestMethod.GET, RequestMethod.POST})
public class UserController  {
	...
	// Mapear metodo update User utilizando Put. Necestiamos acceder al user mediante Id (findById) y definir el nuevo valor
